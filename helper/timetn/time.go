...
// NowLoc - Time Now With Specific Location Timezone
...
// SetTimeDateWithSpecificDate - SetTimeDateWithSpecificDate
func SetTimeDateWithSpecificDate(y int, m time.Month, d int) {
	if y != 0 && m != 0 && d != 0 {
